...
map("n", "gld", function() Snacks.picker.lsp_definitions() end, { desc = "Goto Definition" })
map("n", "glD", function() Snacks.picker.lsp_declarations() end, { desc = "Goto Declaration" })
map("n", "glr", function() Snacks.picker.lsp_references() end, { nowait = true, desc = "References" })
map("n", "gli", function() Snacks.picker.lsp_implementations() end, { desc = "Goto Implementation" })
map("n", "glt", function() Snacks.picker.lsp_type_definitions() end, { desc = "Goto Type Definition" })
map("n", "glk", function() return vim.lsp.buf.signature_help() end, { desc = "Signature Help" })
map("n", "gls", function() Snacks.picker.lsp_symbols() end, { desc = "LSP Symbols" })
map("n", "glS", function() Snacks.picker.lsp_workspace_symbols() end, { desc = "LSP Workspace Symbols" })
...
map("n", "<leader>cc", "<cmd>ConformInfo<cr>", { desc = "Formatter Info" })
map({ "n", "v" }, "<leader>ca", vim.lsp.buf.code_action, { desc = "Code Action" })
map("n", "<leader>cR", function() Snacks.rename.rename_file() end, { desc = "Rename File" })
map("n", "<leader>cr", vim.lsp.buf.rename, { desc = "Rename" })
map("n", "<leader>cA", function() return vim.lsp.buf.code_action({ apply = true, context = { only = { "source" }, diagnostics = {}, }, }) end, { desc = "Source Action" })
...
map("n", "<leader>gHi", function() Snacks.picker.gh_issue() end, { desc = "GitHub Issues (open)" })
map("n", "<leader>gHI", function() Snacks.picker.gh_issue({ state = "all" }) end, { desc = "GitHub Issues (all)" })
map("n", "<leader>gHp", function() Snacks.picker.gh_pr() end, { desc = "GitHub Pull Requests (open)" })
map("n", "<leader>gHP", function() Snacks.picker.gh_pr({ state = "all" }) end, { desc = "GitHub Pull Requests (all)" })
...
map("n", "<leader>ft", function() Snacks.terminal(nil, { cwd = require("utils.helpers").project_root_name() }) end, { desc = "Terminal (Root Dir)" })
map("n", "<c-/>",      function() Snacks.terminal(nil, { cwd = require("utils.helpers").project_root_name() }) end, { desc = "Terminal (Root Dir)" })
map("n", "<c-_>",      function() Snacks.terminal(nil, { cwd = require("utils.helpers").project_root_name() }) end, { desc = "which_key_ignore" })
